...
model_path = '/Users/Kamil/Desktop/koźmiński/Python_Notebooks/1st_sem_3rd_year/final project/ScreenManagerWithNavigation/summarizing_model' # specify model path
...
class OutputScreen(Screen):
    ...
    def save(self):
        try:
            with open(self.manager.get_screen('MainScreen').ids.title.text+'.txt', 'w') as f:
                f.write(self.ids.output_text.text)
        except:
            print('Title not provided!')
    def output(self):
        self.manager.current = 'OutputScreen'
        pass
